            ...
            <div class="panel panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="pull-right">
                        <a href="{{ url('showKategori') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali</a>
                    </div>
                    <br>
                    <br>

                    <form method="post" action="{{ url('kategori_aksi') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="kategori_referensi" required="required">
                        </div>
