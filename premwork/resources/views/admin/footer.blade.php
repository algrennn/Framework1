...
<head>
    <!-- Include your other head elements (meta tags, stylesheets, etc.) here -->
</head>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer-copy-right">
                    <p>Copyright © <?php echo date('Y') ?>. Sistem Informasi Pendidikan Spesial - Special Education. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </div>
